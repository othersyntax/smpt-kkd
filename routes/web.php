...
Route::prefix("/fasiliti")->group(function(){
    ...
    //Carian Fasiliti dari Kontrak
    Route::post('/fasilitiCarian', [FasilitiController::class, 'carian']);
    Route::post('/fasilitiAjax', [FasilitiController::class, 'fasilitiAjax']);
    Route::post('/fasilitiSelectAjax', [FasilitiController::class, 'fasilitiSelectAjax']);
