...
@section('breadcrumb')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Senarai Mukim / Bandar / Pekan</h1>
            </div>
            <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Negeri</label>
                                            {{ Form::select('cari_kod_negeri', negeri(), session('cari_kod_negeri'), ['class'=>'form-control', 'id'=>'cari_kod_negeri']) }}
                                        </div>                                    
                                    </div>
                                    <div class="col-md-4">                                
                                        <div class="form-group">
                            ...
                            <div id="mukim_table">
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        ...
                                        <th width="10%">Kod</th>
                                        <th width="30%">Mukim / Bandar / Pekan</th>
                                        ...
                                        @if ($mukim->count() > 0)
                                            ...
                                            @foreach ($mukim as $mkm)                                      
                                                <tr>
                                                    ...
                                                    <td>{{ $mkm->neg_nama_negeri?  $mkm->neg_nama_negeri : "Tiada rekod" }}</td>                               
...
<script>
    $(function() {
        let cari_kod_negeri = $('[name=cari_kod_negeri]').val();
        getDaerah(cari_kod_negeri, 'dae_kod_daerah', '#list-daerah');
    ...
    $('#cari_kod_negeri').change(function() {
        let cari_kod_negeri = $(this).val();
        // alert('AA');
        getDaerah(cari_kod_negeri, 'neg_kod_negeri', '#list-daerah');
    });
